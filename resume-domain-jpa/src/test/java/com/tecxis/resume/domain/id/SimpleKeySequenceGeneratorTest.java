...
public class SimpleKeySequenceGeneratorTest extends AbstractTest {
    ...
    public static class CountryNullId implements  Serializable, Identifiable  <Long> {
		...
		@Id
    	@GenericGenerator(strategy="com.tecxis.resume.domain.id.SimpleKeySequenceGenerator", name="COUNTRY_SEQ", 
    	 parameters = {
