...
@FunctionalInterface
public interface SetContractSupplyContractsWithNullFunction <K> extends JPATransactionVoidFunction<K> {
	...
	default void afterTransactionCompletion(JdbcTemplate jdbcTemplateProxy) {
		SchemaUtils.testStateAfter_AmesysSagemContract_SupplyContracts_NullUpdate(jdbcTemplateProxy);
