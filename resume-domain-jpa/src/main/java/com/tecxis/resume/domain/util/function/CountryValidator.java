...
public interface CountryValidator extends Function<Country, ValidationResult> {
	...
	static CountryValidator areCitiesValid(City... cities) {
		return country ->  Arrays.asList(cities).containsAll(country.getCities()) ? SUCCESS : COUNTRY_CITIES_ARE_NOT_VALID;
	}
