...
ALTER TABLE "ASSIGNMENT" ADD CONSTRAINT "EXECUTES" FOREIGN KEY ("TASK_ID") REFERENCES "TASK" ("TASK_ID") ON DELETE CASCADE;
ALTER TABLE "ASSIGNMENT" ADD CONSTRAINT "IS COMPOSED OF" FOREIGN KEY ("CLIENT_ID", "PROJECT_ID") REFERENCES "PROJECT" ("CLIENT_ID",	"PROJECT_ID")	ON DELETE CASCADE;
ALTER TABLE "ASSIGNMENT" ADD CONSTRAINT "WORKS ON" FOREIGN KEY ("STAFF_ID")	REFERENCES "STAFF" ("STAFF_ID") ON DELETE CASCADE;
