...
ALTER TABLE "EMPLOYMENT_CONTRACT" ADD CONSTRAINT "PK_EMPLOYMENT_CONTRACT" PRIMARY KEY ("EMPLOYMENT_CONTRACT_ID","STAFF_ID","SUPPLIER_ID")
;
...
ALTER TABLE "STAFF_PROJECT_ASSIGNMENT" ADD CONSTRAINT "IS COMPOSED OF" FOREIGN KEY ("CLIENT_ID", "PROJECT_ID") REFERENCES "PROJECT" ("CLIENT_ID", "PROJECT_ID") ON DELETE CASCADE
;



ALTER TABLE "STAFF_PROJECT_ASSIGNMENT" ADD CONSTRAINT "WORKS ON" FOREIGN KEY ("STAFF_ID") REFERENCES "STAFF" ("STAFF_ID") ON DELETE CASCADE
;



ALTER TABLE "STAFF_PROJECT_ASSIGNMENT" ADD CONSTRAINT "ASSIGNS" FOREIGN KEY ("ASSIGNMENT_ID") REFERENCES "ASSIGNMENT" ("ASSIGNMENT_ID") ON DELETE CASCADE
;



ALTER TABLE "CONTRACT_SERVICE_AGREEMENT" ADD CONSTRAINT "ENGAGES" FOREIGN KEY ("CLIENT_ID", "CONTRACT_ID") REFERENCES "CONTRACT" ("CLIENT_ID", "CONTRACT_ID") ON DELETE CASCADE
;



ALTER TABLE "CONTRACT_SERVICE_AGREEMENT" ADD CONSTRAINT "PROVIDES" FOREIGN KEY ("SERVICE_ID") REFERENCES "SERVICE" ("SERVICE_ID") ON DELETE CASCADE
;
...
INSERT INTO COURSE (COURSE_ID, TITLE) VALUES (COURSE_SEQ.NEXTVAL, 'Java Web Services');

INSERT INTO STAFF (STAFF_ID, FIRSTNAME, LASTNAME, BIRTH_DATE) VALUES(STAFF_SEQ.NEXTVAL, 'Arturo', 'Medecigo Tress', TO_DATE('06/10/1982', 'dd/mm/yyyy'));
--Insert John Smith test staff
INSERT INTO STAFF (STAFF_ID, FIRSTNAME, LASTNAME, BIRTH_DATE) VALUES(STAFF_SEQ.NEXTVAL, 'John', 'Smith', TO_DATE('01/01/1970', 'dd/mm/yyyy'));
...
INSERT INTO STAFF_SKILL (STAFF_ID, SKILL_ID, YEARS_OF_EXPERIENCE, ENDORSEMENT) VALUES( (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'), (SELECT SKILL_ID FROM SKILL WHERE NAME = 'TIBCO'), 8, 100);
INSERT INTO STAFF_SKILL (STAFF_ID, SKILL_ID, YEARS_OF_EXPERIENCE, ENDORSEMENT) VALUES( (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'), (SELECT SKILL_ID FROM SKILL WHERE NAME = 'Oracle'), 8, 95);
INSERT INTO STAFF_SKILL (STAFF_ID, SKILL_ID, YEARS_OF_EXPERIENCE, ENDORSEMENT) VALUES( (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'), (SELECT SKILL_ID FROM SKILL WHERE NAME = 'Java'), 10, 95);
INSERT INTO STAFF_SKILL (STAFF_ID, SKILL_ID, YEARS_OF_EXPERIENCE, ENDORSEMENT) VALUES( (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'), (SELECT SKILL_ID FROM SKILL WHERE NAME = 'Spring'), 4, 50);
INSERT INTO STAFF_SKILL (STAFF_ID, SKILL_ID, YEARS_OF_EXPERIENCE, ENDORSEMENT) VALUES( (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'), (SELECT SKILL_ID FROM SKILL WHERE NAME = 'UNIX'), 4, 50);


INSERT INTO INTEREST (INTEREST_ID, STAFF_ID, "DESC" ) VALUES  (INTEREST_SEQ.NEXTVAL, (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'), 'Apart from being an integration consultant, I enjoy practicing endurance sports. I am an avid short distance runner but after a recent knee injury I''ve found a new passion in road bike riding.' );
INSERT INTO INTEREST (INTEREST_ID, STAFF_ID, "DESC" ) VALUES  (INTEREST_SEQ.NEXTVAL, (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'John'), 'Football soccer and running' );
...
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Barclays%'),                'BarclaysContract');
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Ageas%'),                'AgeasContract');
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Accenture%'),            'AccentureContract');
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Sagemcom%'),                'SagemcomContract');
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Micropole%'),            'MicropoleContract');
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%La Banque Postale%'),     'LbpContract');
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Axeltis%'),                'AxeltisContract1');
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Euler Hermes%'),            'EhContract');
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Axeltis%'),                 'AxeltisContract2');
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Societe Generale%'),     'SGContract');
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Arval%'),                 'ArvalContract');
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE 'Hermes%'),                 'HermesContract');
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Belfius Insurance%'),     'BelfiusContract');

INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'Associate Software Configuration Management'),     (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'BarclaysContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Barclays%')); 
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'Java Integration Developer'),                         (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'AgeasContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Ageas%'));
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'Liferay Developer'),                                 (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'AccentureContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Accenture%'));
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'J2EE Developer'),                                     (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'SagemcomContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Sagemcom%'));
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'Mule ESB Consultant'),                             (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'MicropoleContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Micropole%'));
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'TIBCO Business Works Developer'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'LbpContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%La Banque Postale%'));
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'TIBCO Business Works Developer'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'AxeltisContract1'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Axeltis%'));         
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'TIBCO Business Works Developer'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'EhContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Euler Hermes%'));     
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'TIBCO Business Works Developer'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'AxeltisContract2'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Axeltis%'));        
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'TIBCO Business Works Developer'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'SGContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Societe Generale%'));
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'TIBCO Business Works Developer'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'ArvalContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Arval%'));                 
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'TIBCO Business Works Developer'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'HermesContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE 'Hermes%'));                 
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'TIBCO Business Works Developer'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'BelfiusContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Belfius Insurance%'));


INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ACCENTURE'),             (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Barclays%'),                 (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'BarclaysContract'),    (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'),                 TO_DATE('01/01/2007', 'dd/mm/yyyy'), TO_DATE('01/02/2008', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ACCENTURE'),             (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Ageas%'),                     (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'AgeasContract'),       (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'),           TO_DATE('01/03/2008', 'dd/mm/yyyy'), TO_DATE('01/05/2008', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ACCENTURE'),             (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Accenture%'),                 (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'AccentureContract'),   (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'),          TO_DATE('01/06/2008', 'dd/mm/yyyy'), TO_DATE('01/07/2008', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'AMESYS'),             (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Sagemcom%'),                 (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'SagemcomContract'),       (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'),         TO_DATE('01/10/2008', 'dd/mm/yyyy'), TO_DATE('01/07/2010', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Micropole%'),                 (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'MicropoleContract'),             (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'),            TO_DATE('01/07/2010', 'dd/mm/yyyy'), TO_DATE('01/08/2010', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'La Banque Postale%'),        (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'LbpContract'),                (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'),            TO_DATE('01/09/2010', 'dd/mm/yyyy'), TO_DATE('01/10/2010', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Axeltis%'),                  (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'AxeltisContract1'),            (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'),            TO_DATE('01/11/2010', 'dd/mm/yyyy'), TO_DATE('01/07/2012', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Euler Hermes%'),            (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'EhContract'),                 (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'),               TO_DATE('01/07/2012', 'dd/mm/yyyy'), TO_DATE('01/03/2013', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Axeltis%'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'AxeltisContract2'),           (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'),            TO_DATE('01/05/2013', 'dd/mm/yyyy'), TO_DATE('01/10/2013', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Societe Generale%'),        (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'SGContract'),                 (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'),            TO_DATE('01/10/2013', 'dd/mm/yyyy'), TO_DATE('01/06/2015', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALTERNA'),             (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Arval%'),                     (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'ArvalContract'),         (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'),              TO_DATE('01/06/2015', 'dd/mm/yyyy'), TO_DATE('01/03/2016', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALTERNA'),             (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Hermes%'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'HermesContract'),       (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'),             TO_DATE('01/03/2016', 'dd/mm/yyyy'), TO_DATE('01/08/2016', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALPHATRESS'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Belfius%'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'BelfiusContract'),    (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'),            TO_DATE('01/08/2016', 'dd/mm/yyyy'), null);
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALPHATRESS'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Belfius%'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'BelfiusContract'),    (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'John'),            TO_DATE('01/03/2017', 'dd/mm/yyyy'), TO_DATE('31/12/2019', 'dd/mm/yyyy'));


INSERT INTO EMPLOYMENT_CONTRACT (EMPLOYMENT_CONTRACT_ID, STAFF_ID, SUPPLIER_ID, START_DATE, END_DATE) VALUES (EMPLOYMENT_CONTRACT_SEQ.NEXTVAL, (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ACCENTURE'), 	TO_DATE('01/01/2007', 'dd/mm/yyyy'), TO_DATE('01/07/2008', 'dd/mm/yyyy'));
INSERT INTO EMPLOYMENT_CONTRACT (EMPLOYMENT_CONTRACT_ID, STAFF_ID, SUPPLIER_ID, START_DATE, END_DATE) VALUES (EMPLOYMENT_CONTRACT_SEQ.NEXTVAL, (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'AMESYS'), 		TO_DATE('01/10/2008', 'dd/mm/yyyy'), TO_DATE('01/07/2010', 'dd/mm/yyyy'));
INSERT INTO EMPLOYMENT_CONTRACT (EMPLOYMENT_CONTRACT_ID, STAFF_ID, SUPPLIER_ID, START_DATE, END_DATE) VALUES (EMPLOYMENT_CONTRACT_SEQ.NEXTVAL, (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'), 	TO_DATE('01/07/2010', 'dd/mm/yyyy'), TO_DATE('01/06/2015', 'dd/mm/yyyy'));
INSERT INTO EMPLOYMENT_CONTRACT (EMPLOYMENT_CONTRACT_ID, STAFF_ID, SUPPLIER_ID, START_DATE, END_DATE) VALUES (EMPLOYMENT_CONTRACT_SEQ.NEXTVAL, (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALTERNA'),		TO_DATE('01/06/2015', 'dd/mm/yyyy'), TO_DATE('01/08/2016', 'dd/mm/yyyy'));
INSERT INTO EMPLOYMENT_CONTRACT (EMPLOYMENT_CONTRACT_ID, STAFF_ID, SUPPLIER_ID, START_DATE, END_DATE) VALUES (EMPLOYMENT_CONTRACT_SEQ.NEXTVAL, (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALPHATRESS'),	TO_DATE('01/08/2016', 'dd/mm/yyyy'), null);
INSERT INTO EMPLOYMENT_CONTRACT (EMPLOYMENT_CONTRACT_ID, STAFF_ID, SUPPLIER_ID, START_DATE, END_DATE) VALUES (EMPLOYMENT_CONTRACT_SEQ.NEXTVAL, (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'John'),   (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALPHATRESS'),	TO_DATE('01/03/2017', 'dd/mm/yyyy'), TO_DATE('31/12/2019', 'dd/mm/yyyy'));


INSERT INTO STAFF_PROJECT_ASSIGNMENT (PROJECT_ID, CLIENT_ID, STAFF_ID, ASSIGNMENT_ID) VALUES((SELECT PROJECT_ID FROM PROJECT WHERE NAME='ADIR' AND  VERSION='1.0'), (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Barclays%'), (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'), (SELECT ASSIGNMENT_ID FROM ASSIGNMENT WHERE "DESC"='Contributing to the build, deployment and software configuration lifecycle phases of a three tier Java banking system.'));
...
INSERT INTO STAFF_PROJECT_ASSIGNMENT (PROJECT_ID, CLIENT_ID, STAFF_ID, ASSIGNMENT_ID) VALUES((SELECT PROJECT_ID FROM PROJECT WHERE NAME='FORTIS' AND VERSION='1.0'), (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Ageas%'), (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'), (SELECT ASSIGNMENT_ID FROM ASSIGNMENT WHERE "DESC"='Assisting in the integration of enterprise modules by complying with Enterprise Integration standard patterns.'));
...
INSERT INTO STAFF_PROJECT_ASSIGNMENT (PROJECT_ID, CLIENT_ID, STAFF_ID, ASSIGNMENT_ID) VALUES((SELECT PROJECT_ID FROM PROJECT WHERE NAME='SHERPA' AND VERSION='1.0'), (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Belfius%'), (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'John'), (SELECT ASSIGNMENT_ID FROM ASSIGNMENT WHERE "DESC"='Improvements in the TIBCO maven framework to generate code with new standards and improvement of unit testing tool.'));

INSERT INTO ENROLMENT (COURSE_ID, STAFF_ID, DURATION) VALUES ((SELECT COURSE_ID FROM COURSE WHERE TITLE = 'BW618: TIBCO ActiveMatrix BusinessWorks 6.x Developer Boot Camp'), (SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'), 5);
