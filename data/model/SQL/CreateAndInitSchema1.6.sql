...
/
ALTER TABLE "EMPLOYMENT_CONTRACT" DROP CONSTRAINT "WORKS FOR"
/
...
ALTER TABLE "CONTRACT" ADD CONSTRAINT "PK_CONTRACT_ID" PRIMARY KEY ("CLIENT_ID","CONTRACT_ID")
/
...
ALTER TABLE "SUPPLY_CONTRACT" ADD CONSTRAINT "Key3" PRIMARY KEY ("SUPPLIER_ID","CLIENT_ID","CONTRACT_ID")
/
...
SELECT "CONTRACT"."CONTRACT_ID", "STAFF"."NAME", "LASTNAME", "SERVICE"."NAME" AS "ROLE", "CLIENT"."NAME" AS "CUSTOMER", "START_DATE", "END_DATE", "CITY"."NAME" AS "CITY", "COUNTRY"."NAME" AS "COUNTRY"
...
GROUP BY "CONTRACT"."CONTRACT_ID", "STAFF"."NAME", "LASTNAME", "SERVICE"."NAME", "CLIENT"."NAME", "START_DATE", "END_DATE", "CITY"."NAME", "COUNTRY"."NAME"
ORDER BY "START_DATE"
/

CREATE VIEW "v_Resume" AS
SELECT "CONTRACT"."CONTRACT_ID", "STAFF"."NAME", "LASTNAME", "SERVICE"."NAME" AS "ROLE", "CLIENT"."NAME" AS "CUSTOMER", "START_DATE", "END_DATE", "CITY"."NAME" AS "CITY", "COUNTRY"."NAME" AS "COUNTRY", "PROJECT"."NAME" AS "PROJECT", "ASSIGNMENT"."DESC" AS "RESPONSIBILITY"
FROM "CLIENT", "COUNTRY", "PROJECT", "CONTRACT", "STAFF_PROJECT_ASSIGNMENT", "SERVICE", "STAFF", "CITY", "SUPPLIER", "LOCATION", "ASSIGNMENT", "EMPLOYMENT_CONTRACT", "CONTRACT_SERVICE_AGREEMENT", "SUPPLY_CONTRACT"
WHERE CITY.COUNTRY_ID                         = COUNTRY.COUNTRY_ID AND
LOCATION.CITY_ID                        = CITY.CITY_ID AND 
LOCATION.COUNTRY_ID                     = CITY.COUNTRY_ID AND 
LOCATION.PROJECT_ID                     = PROJECT.PROJECT_ID AND
...
SUPPLIER.SUPPLIER_ID                    = SUPPLY_CONTRACT.SUPPLIER_ID AND
SUPPLIER.SUPPLIER_ID                    = EMPLOYMENT_CONTRACT.SUPPLIER_ID AND
EMPLOYMENT_CONTRACT.STAFF_ID            = STAFF.STAFF_ID AND
ASSIGNMENT.ASSIGNMENT_ID                = STAFF_PROJECT_ASSIGNMENT.ASSIGNMENT_ID
GROUP BY "CONTRACT"."CONTRACT_ID", "STAFF"."NAME", "LASTNAME", "SERVICE"."NAME", "CLIENT"."NAME", "START_DATE", "END_DATE", "CITY"."NAME", "COUNTRY"."NAME", "PROJECT"."NAME", "ASSIGNMENT"."DESC"
ORDER BY "START_DATE"
/
...
ALTER TABLE "EMPLOYMENT_CONTRACT" ADD CONSTRAINT "WORKS FOR" FOREIGN KEY ("STAFF_ID") REFERENCES "STAFF" ("STAFF_ID")
/
...
INSERT INTO INTEREST (INTEREST_ID, STAFF_ID, "DESC" ) VALUES  (INTEREST_SEQ.NEXTVAL, (SELECT STAFF_ID FROM STAFF WHERE NAME = 'John'), 'Football soccer and running' );
...
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME, START_DATE, END_DATE) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Barclays%'),                'AccentureBarlcaysContract',        TO_DATE('01/01/2007', 'dd/mm/yyyy'), TO_DATE('01/02/2008', 'dd/mm/yyyy'));
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME, START_DATE, END_DATE) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Ageas%'),                'AccentureAgeasContract',             TO_DATE('01/03/2008', 'dd/mm/yyyy'), TO_DATE('01/05/2008', 'dd/mm/yyyy'));
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME, START_DATE, END_DATE) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Accenture%'),            'AccentureAccentureContract',        TO_DATE('01/06/2008', 'dd/mm/yyyy'), TO_DATE('01/07/2008', 'dd/mm/yyyy'));
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME, START_DATE, END_DATE) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Sagemcom%'),                'AmesysAccentureContract',            TO_DATE('01/10/2008', 'dd/mm/yyyy'), TO_DATE('01/07/2010', 'dd/mm/yyyy'));
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME, START_DATE, END_DATE) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Micropole%'),            'FastconnectMicropoleContract',     TO_DATE('01/07/2010', 'dd/mm/yyyy'), TO_DATE('01/08/2010', 'dd/mm/yyyy'));
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME, START_DATE, END_DATE) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%La Banque Postale%'),     'FastconnectLbpContract',              TO_DATE('01/09/2010', 'dd/mm/yyyy'), TO_DATE('01/10/2010', 'dd/mm/yyyy'));
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME, START_DATE, END_DATE) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Axeltis%'),                'FastConnectAxeltisContract1',        TO_DATE('01/11/2010', 'dd/mm/yyyy'), TO_DATE('01/07/2012', 'dd/mm/yyyy'));
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME, START_DATE, END_DATE) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Euler Hermes%'),            'FastconnectEhContract',            TO_DATE('01/07/2012', 'dd/mm/yyyy'), TO_DATE('01/03/2013', 'dd/mm/yyyy'));
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME, START_DATE, END_DATE) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Axeltis%'),                 'FasctconnectAxeltisContract2',         TO_DATE('01/05/2013', 'dd/mm/yyyy'), TO_DATE('01/10/2013', 'dd/mm/yyyy'));
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME, START_DATE, END_DATE) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Societe Generale%'),     'FastconnectSGContract',             TO_DATE('01/10/2013', 'dd/mm/yyyy'), TO_DATE('01/06/2015', 'dd/mm/yyyy'));
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME, START_DATE, END_DATE) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Arval%'),                 'AlternaArvalContract',                 TO_DATE('01/06/2015', 'dd/mm/yyyy'), TO_DATE('01/03/2016', 'dd/mm/yyyy'));
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME, START_DATE, END_DATE) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE 'Hermes%'),                 'ArlternaHermesContract',            TO_DATE('01/03/2016', 'dd/mm/yyyy'), TO_DATE('01/08/2016', 'dd/mm/yyyy'));
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME, START_DATE, END_DATE) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Belfius Insurance%'), 	'AlphatressBelfiusContract',  	TO_DATE('01/08/2016', 'dd/mm/yyyy'), null);

INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'Associate Software Configuration Management'),     (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'AccentureBarlcaysContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Barclays%')); 
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'Java Integration Developer'),                         (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'AccentureAgeasContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Ageas%'));
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'Liferay Developer'),                                 (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'AccentureAccentureContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Accenture%'));
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'J2EE Developer'),                                     (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'AmesysAccentureContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Sagemcom%'));
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'Mule ESB Consultant'),                             (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'FastconnectMicropoleContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Micropole%'));
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'TIBCO Business Works Developer'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'FastconnectLbpContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%La Banque Postale%'));
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'TIBCO Business Works Developer'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'FastConnectAxeltisContract1'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Axeltis%'));         
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'TIBCO Business Works Developer'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'FastconnectEhContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Euler Hermes%'));     
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'TIBCO Business Works Developer'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'FasctconnectAxeltisContract2'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Axeltis%'));        
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'TIBCO Business Works Developer'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'FastconnectSGContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Societe Generale%'));
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'TIBCO Business Works Developer'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'AlternaArvalContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Arval%'));                 
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'TIBCO Business Works Developer'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'ArlternaHermesContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE 'Hermes%'));                 
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'TIBCO Business Works Developer'),					(SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'AlphatressBelfiusContract'),	(SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Belfius Insurance%'));

INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ACCENTURE'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Barclays%'),             (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'AccentureBarlcaysContract'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ACCENTURE'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Ageas%'),                 (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'AccentureAgeasContract'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ACCENTURE'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Accenture%'),             (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'AccentureAccentureContract'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'AMESYS'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Sagemcom%'),             (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'AmesysAccentureContract'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'),     (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Micropole%'),             (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'FastconnectMicropoleContract'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'),     (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'La Banque Postale%'),    (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'FastconnectLbpContract'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'),     (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Axeltis%'),                (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'FastConnectAxeltisContract1'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'),     (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Euler Hermes%'),        (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'FastconnectEhContract'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'),     (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Axeltis%'),                (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'FasctconnectAxeltisContract2'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'),     (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Societe Generale%'),    (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'FastconnectSGContract'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALTERNA'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Arval%'),                 (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'AlternaArvalContract'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALTERNA'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Hermes%'),                (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'ArlternaHermesContract'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALPHATRESS'), 	(SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Belfius%'),				(SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'AlphatressBelfiusContract'));


INSERT INTO EMPLOYMENT_CONTRACT (STAFF_ID, SUPPLIER_ID) VALUES ((SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ACCENTURE'));
INSERT INTO EMPLOYMENT_CONTRACT (STAFF_ID, SUPPLIER_ID) VALUES ((SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'AMESYS'));
INSERT INTO EMPLOYMENT_CONTRACT (STAFF_ID, SUPPLIER_ID) VALUES ((SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'));
INSERT INTO EMPLOYMENT_CONTRACT (STAFF_ID, SUPPLIER_ID) VALUES ((SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALTERNA'));
INSERT INTO EMPLOYMENT_CONTRACT (STAFF_ID, SUPPLIER_ID) VALUES ((SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALPHATRESS'));
INSERT INTO EMPLOYMENT_CONTRACT (STAFF_ID, SUPPLIER_ID) VALUES ((SELECT STAFF_ID FROM STAFF WHERE NAME = 'John'),      (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALPHATRESS'));
