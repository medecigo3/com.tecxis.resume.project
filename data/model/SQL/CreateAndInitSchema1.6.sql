...
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME, START_DATE, END_DATE) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Belfius Insurance%'),     'AlphatressBelfiusAmtContract',      TO_DATE('01/08/2016', 'dd/mm/yyyy'), null);
INSERT INTO CONTRACT (CONTRACT_ID, CLIENT_ID, NAME, START_DATE, END_DATE) VALUES(CONTRACT_SEQ.NEXTVAL, (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Belfius Insurance%'),     'AlphatressBelfiusJohnContract',     TO_DATE('01/08/2016', 'dd/mm/yyyy'), null);
...
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'TIBCO Business Works Developer'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'AlphatressBelfiusAmtContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Belfius Insurance%'));
INSERT INTO CONTRACT_SERVICE_AGREEMENT (SERVICE_ID, CONTRACT_ID, CLIENT_ID) VALUES((SELECT SERVICE_ID FROM SERVICE WHERE NAME = 'TIBCO Business Works Developer'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE  NAME = 'AlphatressBelfiusJohnContract'),    (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Belfius Insurance%'));
...
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALPHATRESS'),     (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Belfius%'),                (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'AlphatressBelfiusAmtContract'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALPHATRESS'),      (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Belfius%'),             (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'AlphatressBelfiusJohnContract'));
