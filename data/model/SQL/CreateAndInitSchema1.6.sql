...
SELECT "CONTRACT"."CONTRACT_ID", "STAFF"."NAME", "LASTNAME", "SERVICE"."NAME" AS "ROLE", "CLIENT"."NAME" AS "CUSTOMER", "CITY"."NAME" AS "CITY", "COUNTRY"."NAME" AS "COUNTRY"
...
GROUP BY "CONTRACT"."CONTRACT_ID", "STAFF"."NAME", "LASTNAME", "SERVICE"."NAME", "CLIENT"."NAME", "CITY"."NAME", "COUNTRY"."NAME"
;

CREATE VIEW "v_Resume" AS
SELECT "CONTRACT"."CONTRACT_ID", "CONTRACT"."NAME" AS "CONTRACT", "STAFF"."NAME", "LASTNAME", "SERVICE"."NAME" AS "ROLE", "CLIENT"."NAME" AS "CUSTOMER", "SUPPLIER"."NAME" AS "SUPPLIER", "CITY"."NAME" AS "CITY", "COUNTRY"."NAME" AS "COUNTRY", "PROJECT"."NAME" AS "PROJECT", "ASSIGNMENT"."DESC" AS "RESPONSIBILITY", "START_DATE", "END_DATE"
...
GROUP BY "CONTRACT"."CONTRACT_ID", "CONTRACT"."NAME", "STAFF"."NAME", "LASTNAME", "SERVICE"."NAME", "CLIENT"."NAME", "CITY"."NAME", "COUNTRY"."NAME", "PROJECT"."NAME", "ASSIGNMENT"."DESC", "SUPPLIER"."NAME", "START_DATE", "END_DATE"
;
...
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ACCENTURE'),             (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Barclays%'),                 (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'BarclaysContract'),    (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'),                 TO_DATE('01/01/2007', 'dd/mm/yyyy'), TO_DATE('01/02/2008', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ACCENTURE'),             (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Ageas%'),                     (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'AgeasContract'),       (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'),           TO_DATE('01/03/2008', 'dd/mm/yyyy'), TO_DATE('01/05/2008', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ACCENTURE'),             (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Accenture%'),                 (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'AccentureContract'),   (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'),          TO_DATE('01/06/2008', 'dd/mm/yyyy'), TO_DATE('01/07/2008', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'AMESYS'),             (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Sagemcom%'),                 (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'SagemcomContract'),       (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'),         TO_DATE('01/10/2008', 'dd/mm/yyyy'), TO_DATE('01/07/2010', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Micropole%'),                 (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'MicropoleContract'),             (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'),            TO_DATE('01/07/2010', 'dd/mm/yyyy'), TO_DATE('01/08/2010', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'La Banque Postale%'),        (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'LbpContract'),                (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'),            TO_DATE('01/09/2010', 'dd/mm/yyyy'), TO_DATE('01/10/2010', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Axeltis%'),                  (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'AxeltisContract1'),            (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'),            TO_DATE('01/11/2010', 'dd/mm/yyyy'), TO_DATE('01/07/2012', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Euler Hermes%'),            (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'EhContract'),                 (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'),               TO_DATE('01/07/2012', 'dd/mm/yyyy'), TO_DATE('01/03/2013', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Axeltis%'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'AxeltisContract2'),           (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'),            TO_DATE('01/05/2013', 'dd/mm/yyyy'), TO_DATE('01/10/2013', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Societe Generale%'),        (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'SGContract'),                 (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'),            TO_DATE('01/10/2013', 'dd/mm/yyyy'), TO_DATE('01/06/2015', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALTERNA'),             (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Arval%'),                     (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'ArvalContract'),         (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'),              TO_DATE('01/06/2015', 'dd/mm/yyyy'), TO_DATE('01/03/2016', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALTERNA'),             (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Hermes%'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'HermesContract'),       (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'),             TO_DATE('01/03/2016', 'dd/mm/yyyy'), TO_DATE('01/08/2016', 'dd/mm/yyyy'));
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALPHATRESS'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Belfius%'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'BelfiusContract'),    (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'),            TO_DATE('01/08/2016', 'dd/mm/yyyy'), null);
INSERT INTO SUPPLY_CONTRACT (SUPPLIER_ID, CLIENT_ID, CONTRACT_ID, STAFF_ID, START_DATE, END_DATE) VALUES ((SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALPHATRESS'),         (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Belfius%'),                    (SELECT CONTRACT_ID FROM CONTRACT WHERE NAME = 'BelfiusContract'),    (SELECT STAFF_ID FROM STAFF WHERE NAME = 'John'),            TO_DATE('01/03/2017', 'dd/mm/yyyy'), TO_DATE('31/12/2019', 'dd/mm/yyyy'));
