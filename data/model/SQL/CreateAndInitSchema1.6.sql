...
SELECT "FIRSTNAME", "LASTNAME", "NAME" AS "PROJECT", "VERSION" AS "PROJECT_VERSION", "ASSIGNMENT"."DESC" AS "TASK"
...
INSERT INTO EMPLOYMENT_CONTRACT (STAFF_ID, SUPPLIER_ID) VALUES ((SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ACCENTURE'));
INSERT INTO EMPLOYMENT_CONTRACT (STAFF_ID, SUPPLIER_ID) VALUES ((SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'AMESYS'));
INSERT INTO EMPLOYMENT_CONTRACT (STAFF_ID, SUPPLIER_ID) VALUES ((SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'));
INSERT INTO EMPLOYMENT_CONTRACT (STAFF_ID, SUPPLIER_ID) VALUES ((SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALTERNA'));
INSERT INTO EMPLOYMENT_CONTRACT (STAFF_ID, SUPPLIER_ID) VALUES ((SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'Arturo'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALPHATRESS'));
INSERT INTO EMPLOYMENT_CONTRACT (STAFF_ID, SUPPLIER_ID) VALUES ((SELECT STAFF_ID FROM STAFF WHERE FIRSTNAME = 'John'),      (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALPHATRESS'));
