...
ALTER TABLE "STAFF_ASSIGNMENT" DROP CONSTRAINT "ASSIGNS"
/
ALTER TABLE "STAFF_ASSIGNMENT" DROP CONSTRAINT "WORKS ON"
/
ALTER TABLE "STAFF_ASSIGNMENT" DROP CONSTRAINT "IS COMPOSED OF"
/
