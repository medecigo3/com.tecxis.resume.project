...
ALTER TABLE "SERVICE" DROP CONSTRAINT "ENGAGES"
/
...
ALTER TABLE "SERVICE" ADD CONSTRAINT "PK_SERVICE_ID" PRIMARY KEY ("SERVICE_ID","CLIENT_ID","SUPPLIER_ID","CONTRACT_ID","STAFF_ID")
/
...
FROM "SERVICE", "CLIENT", "CONTRACT", "STAFF", "PROJECT", "COUNTRY", "CITY", "LOCATION", "STAFF_PROJECT_ASSIGNMENT", "SUPPLIER"
...
CONTRACT.CONTRACT_ID = SERVICE.CONTRACT_ID AND
CONTRACT.CLIENT_ID  = SERVICE.CLIENT_ID AND
CONTRACT.SUPPLIER_ID = SERVICE.SUPPLIER_ID AND
CONTRACT.STAFF_ID = SERVICE.STAFF_ID AND
SERVICE.SUPPLIER_ID = SUPPLIER.SUPPLIER_ID AND
CONTRACT.SUPPLIER_ID = SUPPLIER.SUPPLIER_ID AND
STAFF.STAFF_ID = SUPPLIER.STAFF_ID 
...
ALTER TABLE "SERVICE" ADD CONSTRAINT "ENGAGES" FOREIGN KEY ("CLIENT_ID", "SUPPLIER_ID", "CONTRACT_ID", "STAFF_ID") REFERENCES "CONTRACT" ("CLIENT_ID", "SUPPLIER_ID", "CONTRACT_ID", "STAFF_ID")
/
...
INSERT INTO SERVICE (SERVICE_ID, CONTRACT_ID, CLIENT_ID, SUPPLIER_ID, STAFF_ID, NAME) VALUES(SERVICE_SEQ.NEXTVAL, (SELECT CONTRACT_ID FROM CONTRACT WHERE  START_DATE = TO_DATE('01/01/2007', 'dd/mm/yyyy') AND END_DATE = TO_DATE('01/02/2008', 'dd/mm/yyyy')), (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Barclays%'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ACCENTURE'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), 'Associate Software Configuration Management'); 
INSERT INTO SERVICE (SERVICE_ID, CONTRACT_ID, CLIENT_ID, SUPPLIER_ID, STAFF_ID, NAME) VALUES(SERVICE_SEQ.NEXTVAL, (SELECT CONTRACT_ID FROM CONTRACT WHERE  START_DATE = TO_DATE('01/03/2008', 'dd/mm/yyyy') AND END_DATE = TO_DATE('01/05/2008', 'dd/mm/yyyy')), (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Ageas%'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ACCENTURE'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), 'Java Integration Developer');
INSERT INTO SERVICE (SERVICE_ID, CONTRACT_ID, CLIENT_ID, SUPPLIER_ID, STAFF_ID, NAME) VALUES(SERVICE_SEQ.NEXTVAL, (SELECT CONTRACT_ID FROM CONTRACT WHERE  START_DATE = TO_DATE('01/06/2008', 'dd/mm/yyyy') AND END_DATE = TO_DATE('01/07/2008', 'dd/mm/yyyy')), (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Accenture%'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ACCENTURE'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), 'Liferay Developer');
INSERT INTO SERVICE (SERVICE_ID, CONTRACT_ID, CLIENT_ID, SUPPLIER_ID, STAFF_ID, NAME) VALUES(SERVICE_SEQ.NEXTVAL, (SELECT CONTRACT_ID FROM CONTRACT WHERE  START_DATE = TO_DATE('01/10/2008', 'dd/mm/yyyy') AND END_DATE = TO_DATE('01/07/2010', 'dd/mm/yyyy')), (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Sagemcom%'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'AMESYS'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), 'J2EE Developer');
INSERT INTO SERVICE (SERVICE_ID, CONTRACT_ID, CLIENT_ID, SUPPLIER_ID, STAFF_ID, NAME) VALUES(SERVICE_SEQ.NEXTVAL, (SELECT CONTRACT_ID FROM CONTRACT WHERE  START_DATE = TO_DATE('01/07/2010', 'dd/mm/yyyy') AND END_DATE = TO_DATE('01/08/2010', 'dd/mm/yyyy')), (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Micropole%'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), 'Mule ESB Consultant');
INSERT INTO SERVICE (SERVICE_ID, CONTRACT_ID, CLIENT_ID, SUPPLIER_ID, STAFF_ID, NAME) VALUES(SERVICE_SEQ.NEXTVAL, (SELECT CONTRACT_ID FROM CONTRACT WHERE  START_DATE = TO_DATE('01/09/2010', 'dd/mm/yyyy') AND END_DATE = TO_DATE('01/10/2010', 'dd/mm/yyyy')), (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%La Banque Postale%'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), 'TIBCO Business Works Developer');
INSERT INTO SERVICE (SERVICE_ID, CONTRACT_ID, CLIENT_ID, SUPPLIER_ID, STAFF_ID, NAME) VALUES(SERVICE_SEQ.NEXTVAL, (SELECT CONTRACT_ID FROM CONTRACT WHERE  START_DATE = TO_DATE('01/11/2010', 'dd/mm/yyyy') AND END_DATE = TO_DATE('01/07/2012', 'dd/mm/yyyy')), (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Axeltis%'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), 'TIBCO Business Works Developer');         
INSERT INTO SERVICE (SERVICE_ID, CONTRACT_ID, CLIENT_ID, SUPPLIER_ID, STAFF_ID, NAME) VALUES(SERVICE_SEQ.NEXTVAL, (SELECT CONTRACT_ID FROM CONTRACT WHERE  START_DATE = TO_DATE('01/07/2012', 'dd/mm/yyyy') AND END_DATE = TO_DATE('01/03/2013', 'dd/mm/yyyy')), (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Euler Hermes%'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'),(SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), 'TIBCO Business Works Developer');     
INSERT INTO SERVICE (SERVICE_ID, CONTRACT_ID, CLIENT_ID, SUPPLIER_ID, STAFF_ID, NAME) VALUES(SERVICE_SEQ.NEXTVAL, (SELECT CONTRACT_ID FROM CONTRACT WHERE  START_DATE = TO_DATE('01/05/2013', 'dd/mm/yyyy') AND END_DATE = TO_DATE('01/10/2013', 'dd/mm/yyyy')), (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Axeltis%'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), 'TIBCO Business Works Developer');        
INSERT INTO SERVICE (SERVICE_ID, CONTRACT_ID, CLIENT_ID, SUPPLIER_ID, STAFF_ID, NAME) VALUES(SERVICE_SEQ.NEXTVAL, (SELECT CONTRACT_ID FROM CONTRACT WHERE  START_DATE = TO_DATE('01/10/2013', 'dd/mm/yyyy') AND END_DATE = TO_DATE('01/06/2015', 'dd/mm/yyyy')), (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Societe Generale%'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'FASTCONNECT'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), 'TIBCO Business Works Developer');
INSERT INTO SERVICE (SERVICE_ID, CONTRACT_ID, CLIENT_ID, SUPPLIER_ID, STAFF_ID, NAME) VALUES(SERVICE_SEQ.NEXTVAL, (SELECT CONTRACT_ID FROM CONTRACT WHERE  START_DATE = TO_DATE('01/06/2015', 'dd/mm/yyyy') AND END_DATE = TO_DATE('01/03/2016', 'dd/mm/yyyy')), (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Arval%'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALTERNA'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), 'TIBCO Business Works Developer');                 
INSERT INTO SERVICE (SERVICE_ID, CONTRACT_ID, CLIENT_ID, SUPPLIER_ID, STAFF_ID, NAME) VALUES(SERVICE_SEQ.NEXTVAL, (SELECT CONTRACT_ID FROM CONTRACT WHERE  START_DATE = TO_DATE('01/03/2016', 'dd/mm/yyyy') AND END_DATE = TO_DATE('01/08/2016', 'dd/mm/yyyy')), (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE 'Hermes%'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALTERNA'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), 'TIBCO Business Works Developer');                 
INSERT INTO SERVICE (SERVICE_ID, CONTRACT_ID, CLIENT_ID, SUPPLIER_ID, STAFF_ID, NAME) VALUES(SERVICE_SEQ.NEXTVAL, (SELECT CONTRACT_ID FROM CONTRACT WHERE  START_DATE = TO_DATE('01/08/2016', 'dd/mm/yyyy') AND END_DATE is null AND STAFF_ID = (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo')), (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Belfius Insurance%'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALPHATRESS' AND STAFF_ID = (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo')), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), 'TIBCO Business Works Developer');
INSERT INTO SERVICE (SERVICE_ID, CONTRACT_ID, CLIENT_ID, SUPPLIER_ID, STAFF_ID, NAME) VALUES(SERVICE_SEQ.NEXTVAL, (SELECT CONTRACT_ID FROM CONTRACT WHERE  START_DATE = TO_DATE('01/08/2016', 'dd/mm/yyyy') AND END_DATE is null AND STAFF_ID = (SELECT STAFF_ID FROM STAFF WHERE NAME = 'John')), (SELECT CLIENT_ID FROM CLIENT WHERE NAME LIKE '%Belfius Insurance%'), (SELECT SUPPLIER_ID FROM SUPPLIER WHERE NAME = 'ALPHATRESS' AND STAFF_ID = (SELECT STAFF_ID FROM STAFF WHERE NAME = 'John')), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'John'), 'TIBCO Business Works Developer');
