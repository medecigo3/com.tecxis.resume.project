...
ALTER TABLE "ASSIGNING" DROP CONSTRAINT "ASSIGNS"
/
ALTER TABLE "ASSIGNING" DROP CONSTRAINT "WORKS ON"
/
ALTER TABLE "ASSIGNING" DROP CONSTRAINT "IS COMPOSED OF"
/
...
-- Add keys for table ASSIGNING

ALTER TABLE "ASSIGNING" ADD CONSTRAINT "PK_ASSIGNMENT_ID" PRIMARY KEY ("ASSIGNMENT_ID","PROJECT_ID")
/
...
ALTER TABLE "ASSIGNING" ADD CONSTRAINT "IS COMPOSED OF" FOREIGN KEY ("CLIENT_ID", "PROJECT_ID") REFERENCES "PROJECT" ("CLIENT_ID", "PROJECT_ID")
/

ALTER TABLE "ASSIGNING" ADD CONSTRAINT "WORKS ON" FOREIGN KEY ("STAFF_ID") REFERENCES "STAFF" ("STAFF_ID")
/

ALTER TABLE "ASSIGNING" ADD CONSTRAINT "ASSIGNS" FOREIGN KEY ("ASSIGNMENT_ID") REFERENCES "ASSIGNMENT" ("ASSIGNMENT_ID")
/
...
INSERT INTO ASSIGNMENT (ASSIGNMENT_ID, "DESC") VALUES (ASSIGNMENT_SEQ.NEXTVAL, 'Coding of Business Works processes to transform and integrate XML investment funds into a corporate database.');
...
INSERT INTO ASSIGNING (PROJECT_ID, CLIENT_ID, STAFF_ID, ASSIGNMENT_ID) VALUES((SELECT PROJECT_ID FROM PROJECT WHERE NAME='FORTIS' AND VERSION='1.0'), (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Ageas%'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), (SELECT ASSIGNMENT_ID FROM ASSIGNMENT WHERE "DESC"='Assisting in the integration of enterprise modules by complying with Enterprise Integration standard patterns.'));
...
INSERT INTO ASSIGNING (PROJECT_ID, CLIENT_ID, STAFF_ID, ASSIGNMENT_ID) VALUES((SELECT PROJECT_ID FROM PROJECT WHERE NAME='EOLIS' AND VERSION='1.0'), (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Euler%'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), (SELECT ASSIGNMENT_ID FROM ASSIGNMENT WHERE "DESC"='Running unit tests to validate code against functional specifications.'));
INSERT INTO ASSIGNING (PROJECT_ID, CLIENT_ID, STAFF_ID, ASSIGNMENT_ID) VALUES((SELECT PROJECT_ID FROM PROJECT WHERE NAME='EOLIS' AND VERSION='1.0'), (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Euler%'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), (SELECT ASSIGNMENT_ID FROM ASSIGNMENT WHERE "DESC"='Writing of functional and technical documentation.'));          
INSERT INTO ASSIGNING (PROJECT_ID, CLIENT_ID, STAFF_ID, ASSIGNMENT_ID) VALUES((SELECT PROJECT_ID FROM PROJECT WHERE NAME='MORNINGSTAR' AND VERSION='2.0'),  (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Axeltis%'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), (SELECT ASSIGNMENT_ID FROM ASSIGNMENT WHERE "DESC"='Coding of Business Works processes to transform and integrate XML investment funds into a corporate database.'));
INSERT INTO ASSIGNING (PROJECT_ID, CLIENT_ID, STAFF_ID, ASSIGNMENT_ID) VALUES((SELECT PROJECT_ID FROM PROJECT WHERE NAME='MORNINGSTAR' AND VERSION='2.0'),  (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Axeltis%'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), (SELECT ASSIGNMENT_ID FROM ASSIGNMENT WHERE "DESC"='Setup of TIBCO web services to expose financial business data services.'));
INSERT INTO ASSIGNING (PROJECT_ID, CLIENT_ID, STAFF_ID, ASSIGNMENT_ID) VALUES((SELECT PROJECT_ID FROM PROJECT WHERE NAME='MORNINGSTAR' AND VERSION='2.0'),  (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Axeltis%'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), (SELECT ASSIGNMENT_ID FROM ASSIGNMENT WHERE "DESC"='Coding of XSLT style sheets for transformation of XML raw data to canonical data.'));
INSERT INTO ASSIGNING (PROJECT_ID, CLIENT_ID, STAFF_ID, ASSIGNMENT_ID) VALUES((SELECT PROJECT_ID FROM PROJECT WHERE NAME='MORNINGSTAR' AND VERSION='2.0'),  (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Axeltis%'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), (SELECT ASSIGNMENT_ID FROM ASSIGNMENT WHERE "DESC"='Coding of Business Works processes to automate the extraction, transformation, and transfer of client data.'));
INSERT INTO ASSIGNING (PROJECT_ID, CLIENT_ID, STAFF_ID, ASSIGNMENT_ID) VALUES((SELECT PROJECT_ID FROM PROJECT WHERE NAME='MORNINGSTAR' AND VERSION='2.0'),  (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Axeltis%'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), (SELECT ASSIGNMENT_ID FROM ASSIGNMENT WHERE "DESC"='Running unit tests to validate code against functional specifications.'));
INSERT INTO ASSIGNING (PROJECT_ID, CLIENT_ID, STAFF_ID, ASSIGNMENT_ID) VALUES((SELECT PROJECT_ID FROM PROJECT WHERE NAME='MORNINGSTAR' AND VERSION='2.0'),  (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Axeltis%'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), (SELECT ASSIGNMENT_ID FROM ASSIGNMENT WHERE "DESC"='Writing of functional and technical documentation.'));    
INSERT INTO ASSIGNING (PROJECT_ID, CLIENT_ID, STAFF_ID, ASSIGNMENT_ID) VALUES((SELECT PROJECT_ID FROM PROJECT WHERE NAME='CENTRE_DES_COMPETENCES' AND VERSION='1.0'), (SELECT CLIENT_ID FROM CLIENT WHERE NAME  LIKE 'Societe%'), (SELECT STAFF_ID FROM STAFF WHERE NAME = 'Arturo'), (SELECT ASSIGNMENT_ID FROM ASSIGNMENT WHERE "DESC"='Advising on TIBCO Business Works coding patterns and best practice support for Paris region and abroad.'));
