...
ALTER TABLE "ASSIGNING" ADD CONSTRAINT "PK_ASSIGNMENT_ID" PRIMARY KEY ("ASSIGNMENT_ID","PROJECT_ID","STAFF_ID","CLIENT_ID")
/
...
FROM "SERVICE", "CLIENT", "CONTRACT", "STAFF", "PROJECT", "COUNTRY", "CITY", "LOCATION", "ASSIGNING"
...
PROJECT.PROJECT_ID = ASSIGNING.PROJECT_ID AND
PROJECT.CLIENT_ID = ASSIGNING.CLIENT_ID AND
ASSIGNING.STAFF_ID = STAFF.STAFF_ID AND
