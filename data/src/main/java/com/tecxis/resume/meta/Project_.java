...
public class Project_ {
	public static volatile SingularAttribute<Project, Project.ProjectPK> projectId;
	public static volatile SingularAttribute<Project, Project.ProjectPK> clientId;
